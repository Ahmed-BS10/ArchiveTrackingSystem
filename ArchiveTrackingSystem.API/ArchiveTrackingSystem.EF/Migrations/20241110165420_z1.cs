    ...
    public partial class z1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Addreess", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Slug = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NumberActive = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileOutsideArchives", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileOutsideArchives_Employes_EmployeID",
                        column: x => x.EmployeID,
                        principalTable: "Employes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileOutsideArchives_Files_FileID",
                        column: x => x.FileID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FileOutsideArchives_EmployeID",
                table: "FileOutsideArchives",
                column: "EmployeID");

            migrationBuilder.CreateIndex(
                name: "IX_FileOutsideArchives_FileID",
                table: "FileOutsideArchives",
                column: "FileID");
